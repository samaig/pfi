      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-white">
        <div className="w-full max-w-[440px]">
          ...
          <p className="text-sm text-[#6F6F6F] mt-2 mb-8">
            Sign in to access your employer-enabled benefits
          </p>
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <svg className="mr-2 h-5 w-5 shrink-0" viewBox="0 0 21 21" fill="none">
          ...
          <div className="mt-6 text-center space-y-2">
            ...
            <p>
              <Link
                href="#"
                className="text-sm text-[#6F6F6F] hover:text-[#1C1C1C] hover:underline"
              >
                Forgot password?
              </Link>
            </p>
